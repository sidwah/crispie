...
const HeroSection = () => {
  ...
  return (
    <section className="bg-[#f2f2f2] min-h-screen relative overflow-hidden">
      <div className="container mx-auto px-6 md:px-12 py-10 md:py-16 flex flex-col md:flex-row justify-between relative">
        {/* Text Block */}
        <div className="md:w-1/2 z-10 md:text-left">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-normal mb-6 tracking-tight leading-[1.1] inline-block">
            <div className="text">Cookies That Feel</div>
            <div className="text">Like a Hug.</div>
          </h1>
        ...
        <div className="md:absolute md:-right-20 md:ml-4 md:top-1/2 md:transform md:-translate-y-1/2 w-full md:w-auto inline-flex">
